...
| `S-ROOM-007` | checked Task 2.2 any-player abort | abstracted Task 3.1: abort assertion | checked Task 3.2 abort-before-expiry | queried Task 3.3 abort successor/history | checked Tasks 2.4/4.3 abort script | planned multi-client | checked Task 4.3 abort replay; controls pending |
...
| `S-ROOM-011` | checked Task 2.2 any-player pause | checked Task 3.1 player-gated pause | checked Task 3.2 pause state/gate | queried Task 3.3 both player predecessors | checked Tasks 2.4/4.3 pause script | planned multi-client | checked Task 4.3 paused text; controls pending |
| `S-ROOM-012` | checked Task 2.2 any-player unpause | checked Task 3.1 player-gated resume | checked Task 3.2 resume/liveness | queried Task 3.3 both player predecessors | checked Tasks 2.4/4.3 resume script | planned multi-client | checked Task 4.3 resume replay; controls pending |
...
| `S-VIEW-006` | checked Task 2.3 pairwise viewer test | checked Task 3.1 `ScopedSpectatorGrant` | abstracted Task 3.2: grant flag | queried Task 3.3 exact can-see matrix | checked Task 2.3 scoped hand shape | planned recipient capture | checked Task 4.3 granted-hand text; egui pending |
